  ...
  Future<void> getVacasPrenhas() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          vacas = vacasData
              .map<Vaca>((data) => Vaca.fromJson(data))
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        actions: [
          ElevatedButton(
            onPressed: () {
              Navigator.pushReplacementNamed(context, '/listPrenha'); // Redireciona para a rota '/listPrenha'
            },
            child: const Text('OK'),
          ),
        ],
          ...
          child: Column(
            children: [
              DropdownButtonFormField<int>(
                ...
                dropdownColor: Colors.white, // Cor de fundo do DropdownButtonFormField
                style: TextStyle(
                ...
                items: vacas.map((vaca) {
                  return DropdownMenuItem<int>(
                    ...
                    child: Text(
                      vaca.nomeVaca ?? '',
                      style: TextStyle(
                        color: Colors.black, // Cor do texto dos itens da lista suspensa
                      ),
                    ),
                  );
                }).toList(),
